...
@endsection
@section('title')
Demmande attestation de travail
@endsection
@section('content')
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{route('créeDemmandeTrav')}}" class="btn add-btn"><i class="fa fa-plus"></i>Crée une demmande att-travail </a>
                    </div>
                </div>
            </div>
        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="form-control" disabled name="type">
                                                            <option value="2" selected>Travaile</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
